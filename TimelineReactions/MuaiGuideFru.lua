local tbl = 
{
	...
	[9] = 
	{
		
		{
			data = 
			{
				name = "[Kaze] Pitch Perfect 15",
				uuid = "38b77522-4590-3caf-99a3-cda769a88a6a",
				version = 2,
			},
			inheritedObjectUUID = "f8a4b642-0819-3629-80a9-3abc95e0dd71",
			inheritedOverwrites = 
			{
	...
	[80] = 
	{
			...
			data = 
			{
				...
				conditions = 
				{
					
					{
						...
						{
							category = "Lua",
							conditionLua = "return MuAiGuide and MuAiGuide.Config.FruCfg.FruLightRampantType == 2",
							name = "灰9式",
							uuid = "d61da128-1e8a-58ef-a605-bd41ca15d360",
							version = 2,
						},
				...
				mechanicTime = 331.8,
				name = "[MuAiGuide]灰9光暴-预站位",
				timelineIndex = 80,
				timerOffset = -5,
				uuid = "932d70b5-d3ab-f3f1-94b1-e21c9605aaad",
				version = 2,
			},
			inheritedIndex = 5,
		},
				...
				conditions = 
				{
					
					{
						data = 
						{
							...
							conditionLua = "return MuAiGuide and MuAiGuide.Config.FruCfg.FruLightRampantType == 2",
							name = "灰9式",
							uuid = "b83bf4e1-6302-cb46-bd67-8ebfa3564893",
							version = 2,
						},
					},
				},
				mechanicTime = 331.8,
				name = "[MuAiGuide]灰9光暴-线分析&指路",
				timelineIndex = 80,
				timerOffset = 1,
				uuid = "b40533b2-40cc-bd08-a899-c36cbb637e0f",
				version = 2,
			},
			inheritedIndex = 6,
		},
		
		{
			data = 
			{
				...
				mechanicTime = 331.8,
				name = "[MuAiGuide]灰9光暴-左右分组统计",
				timelineIndex = 80,
				timerOffset = 2,
				uuid = "4024946b-384d-3afd-9a92-b04378894619",
				version = 2,
			},
			inheritedIndex = 7,
		},
			...
			data = 
			{
				...
				conditions = 
				{
					...
					
					{
						...
						{
							category = "Lua",
							conditionLua = "return MuAiGuide.Config.FruCfg.GuideType == 2",
							name = "日基",
			...
			data = 
			{
				...
				conditions = 
				{
					
					{
						...
						{
							category = "Lua",
							conditionLua = "return data.MuAiGd_P3_1_type ~= nil and data.MuAiGd_P3_1_type > 0 and MuAiGuide.Config.FruCfg.GuideType == 2",
			...
			data = 
			{
				actions = 
				{
					
					{
						...
						{
							aType = "Lua",
							actionLua = "local jobLeft = {}\nfor job, ent in pairs(MuAiGuide.Party) do\n    local curPlayer = TensorCore.mGetEntity(ent.id)\n    if curPlayer.marker ~= nil then\n        if curPlayer.marker <= 4 then\n            jobLeft[job] = true\n        else\n            jobLeft[job] = false\n        end\n    end\nend\n\nif jobLeft[MuAiGuide.SelfPos] ~= data.MuAiGd_P3_2_PlayerBuffType[MuAiGuide.SelfPos].IsLeft then\n    if jobLeft[MuAiGuide.SelfPos] == true then\n        MuAiGuide.Info(\"检测到标记，计算结论冲突，尝试修正分组到左侧。\")\n        data.MuAiGd_P3_2_PlayerBuffType[MuAiGuide.SelfPos].IsLeft = true\n    else\n        MuAiGuide.Info(\"检测到标记，计算结论冲突，尝试修正分组到右侧。\")\n        data.MuAiGd_P3_2_PlayerBuffType[MuAiGuide.SelfPos].IsLeft = false\n    end\nelse\n    MuAiGuide.Info(\"检测到标记，计算结论相同，不进行修正。\")\nend\nself.used = true",
							conditions = 
							{
				...
				conditions = 
				{
					
					{
						...
						{
							category = "Lua",
							conditionLua = "return MuAiGuide.Config.FruCfg.ApocalypseGroupType ~= 1 and MuAiGuide.GetPlayer().marker ~= nil and MuAiGuide.GetPlayer().marker > 0",
					...
					
					{
						data = 
						{
							...
							conditions = 
							{
								...
								{
									"8b44c5cc-7635-bd69-a212-37d95b810ec5",
									true,
								},
							},
							gVar = "ACR_TensorRequiem3_CD",
				...
				conditions = 
				{
					
					{
						data = 
						{
							...
							conditionLua = "return MuAiGuide.Config.FruCfg.GuideType == 1",
							name = "不是日基",
							uuid = "8b44c5cc-7635-bd69-a212-37d95b810ec5",
							version = 2,
						},
					},
				},
			...
			data = 
			{
				...
				conditions = 
				{
					
					{
						...
						{
							category = "Lua",
							conditionLua = "return  MuAiGuide.Config.FruCfg.GuideType ==  2 and data.MuAiGd_P4_2_RedIceHead ~= nil and data.MuAiGd_P4_2_RedIceHead  == true",
