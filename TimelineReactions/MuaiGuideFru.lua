			...
			data = 
			{
				actions = 
				{
					
					{
						...
						{
							aType = "Lua",
							actionLua = "for i, v in pairs(data.MuAiGd_P3_1_Lights) do\n\td(v.entity.id)\nend\nself.used = true",
							gVar = "ACR_TensorRequiem3_CD",
							uuid = "b8225255-ebc8-e792-ab8b-43d9ef51c4bb",
							version = 2.1,
						},
					},
				},
				...
				name = "DEBUG",
				timelineIndex = 123,
				uuid = "8603f58a-b680-2c2f-9a2c-61aef8526af7",
				version = 2,
			},
		},
	},
