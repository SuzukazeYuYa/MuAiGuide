			...
			data = 
			{
					...
					
					{
						data = 
						{
							...
							conditions = 
							{
								...
								{
									"705bed92-932e-c948-8555-b757b01f05da",
									true,
								},
							},
							gVar = "ACR_TensorRequiem3_CD",
				...
				conditions = 
				{
					...
					
					{
						...
						{
							category = "Lua",
							conditionLua = "return MuAiGuide.GetPlayer().marker ~= nil and MuAiGuide.GetPlayer().marker > 0",
							name = "有标记",
							uuid = "705bed92-932e-c948-8555-b757b01f05da",
							version = 2,
						},
					},
				},
