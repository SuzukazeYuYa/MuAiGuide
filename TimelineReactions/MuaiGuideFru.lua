			...
			data = 
			{
				...
				conditions = 
				{
					
					{
						...
						{
							category = "Lua",
							conditionLua = "return MuAiGuide.Config.FruCfg.GuideType == 1 and MuAiGuide.Config.FruCfg.ApocalypseGroupType == 1",
							name = "不是日基",
